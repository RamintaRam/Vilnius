    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" style="text-align: center; font-weight: 600; font-size: 20px; color: #636b6f">Administratoriaus paskyra</div>
                <div class="panel-body">
                    <div style="float: left">
                        <a href="{{route('app.inhabitants.index')}}" class="btn btn-secondary btn btn-block" style="border: 1px solid #d3e0e9; width: 350px; color: #777;">Gyventojai</a>
                    ...
                    <div style="float: left">
                        ...
                        <a href="{{route('app.gender.index')}}" class="btn btn-secondary btn btn-block" style="border: 1px solid #d3e0e9; width: 350px; color: #777">Lytis</a>
